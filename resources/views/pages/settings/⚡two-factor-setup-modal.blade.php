    ...
    public function getModalConfigProperty(): array
    {
        if ($this->setupComplete) {
            return [
                ...
                'description' => __('La autenticación de dos factores ya está habilitada. Escanea el código QR o introduce la clave de configuración en tu app de autenticación.'),
        ...
        return [
            'title' => __('Habilitar la autenticación de dos factores'),
            'description' => __('Para terminar de habilitar la autenticación de dos factores, escanee el código QR o ingrese la clave de configuración en su aplicación de autenticación.'),
            'buttonText' => __('Continuar'),
        ];
    }
}; ?>
